class Bullet {
  ...
  constructor(x, y, speed, damage) {
    ...
    this.color = "red";
    this.img = new Image();
    this.img.src = "/images/jetpackman-images/gun_flash.png";
    this.imgMonster = new Image();
    this.imgMonster.src = "/images/jetpackman-images/missil.png";
    this.missil = document.createElement('audio')
    this.missil.src = "/song/jetpackman-song/Missil.mp3"
    this.missil.volume = 0.01
    this.gun = document.createElement('audio')
    this.gun.src = "/song/jetpackman-song/gun_shoot.mp3"
