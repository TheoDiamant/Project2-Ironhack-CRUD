class Player extends Component {
    ...
    constructor(x, y, w, h ,bulletController,name) {
        ...
        this.hp_bar.src= "/images/jetpackman-images/hp_bar.png"
        this.gas = new Image();
        this.gas.src = "/images/jetpackman-images/gas-can.png";
        this.coin = new Image();
        this.coin.src= "/images/jetpackman-images/coin.png";
        this.head = new Image();
        this.head.src = "/images/jetpackman-images/head_white_helmet.png";
        ...
        this.jetpack.src = "/song/jetpackman-song/jetpack.mp3"
        this.jetpack.volume = 0.03
    
        this.coinSound = document.createElement('audio')
        this.coinSound.src = "/song/jetpackman-song/coin.mp3"
        this.coinSound.volume = 0.1
        this.hit = document.createElement('audio')
        this.hit.src = "/song/jetpackman-song/player_hit.mp3"
    ...
    for(let i = 0 ; i < this.t ; i++){
        ...
        if(i>=10)
        {
            this.img[a][i].src = `/images/jetpackman-images/${folder}/tile0`+ i.toString() +'.png';

        }
        else {
            this.img[a][i].src = `/images/jetpackman-images/${folder}/tile00`+ i.toString() +'.png';
